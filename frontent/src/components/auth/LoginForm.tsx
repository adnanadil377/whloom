...
const LoginForm = ({ userType, onSubmit, isLoading, error }: LoginFormProps) => {
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');
  const [showPassword, setShowPassword] = useState(false);

  const label = userType === 'business' ? 'Business' : 'Creator';
  const signupPath = userType === 'business' ? '/business/signup' : '/creator/signup';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 text-sm">Sign in to your {label} account</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link to={signupPath} className="text-purple-600 hover:text-purple-700 font-medium">
            Sign up
          </Link>
        </p>
